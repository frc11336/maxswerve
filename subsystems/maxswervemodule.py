...
from rev import SparkMax, SparkMaxConfig, ClosedLoopConfig, ResetMode, PersistMode, FeedbackSensor 
...
class MAXSwerveModule:
    def __init__(
        ...
        # Set smart current limits for safety
        self.drivingConfig.smartCurrentLimit(40)  # NEO recommended limit
        self.turningConfig.smartCurrentLimit(20)  # NEO 550 recommended limit
